...
export default function Navbar() {
    ...
    return (
        <nav className={`relative m-2 px-5 md:px-10 ${show ? 'min-h-64' : 'min-h-20' } transition-all flex-wrap md:max-h-20 flex justify-between rounded-lg border border-[#52bedc] items-center backdrop-blur-xl`}>
            ...
            <div id="nav-links" className={`md:flex ${show ? ' w-full flex flex-col items-center justify-center ': 'hidden'}  transition-all  md:flex-row md:gap-14`}>
                <li className='list-none w-fit'><a className='p-2 text-3xl text-[#52bedc] transition-all' href="#">Home</a></li>
                <li className='list-none w-fit'><a className='p-2 text-3xl hover:text-[#52bedc] transition-all' href="#">Community</a></li>
