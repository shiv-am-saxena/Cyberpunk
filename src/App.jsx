...
export default function App() {
	...
	return (
		<>
			{screenLoading ? <div className={`transition-all ${screenLoading? 'block': 'h-0 duration-500'}`} onClick={()=>{setScreenLoading(false)}}><Loading /> </div>: <div className='h-screen flex flex-col gap-5'>
